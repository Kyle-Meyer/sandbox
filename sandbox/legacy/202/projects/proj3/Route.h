...
class Route {
 ...
 ~Route();
  ...
  //****NOTE*** I KNOW IM NOT SUPPOSED TO ALTER THIS HEADER FILE, BUT THESE FUNCTIONS
  //ARE THE EXACT SAME AS THEIR DEFAULT COUNTER PARTS I JUST NOW TRAVERSE AND OPTOMIZE
  //THE LIST BASED ON THE ACTUAL STOP LOCATION RATHER THAN INDEX VALUE
  //I WASNT SURE WHAT THE CORRECT WAY WAS SO I MADE THESE TO SHOW THAT
  //YOU CAN DO BOTH
  void removeStop1(int stopLocation);
  void optimizeroute1(double rideFare);
 private:
